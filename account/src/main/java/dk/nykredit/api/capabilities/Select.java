...
/**
 * selection on the basis of attribute values and having the ability for using
 * selection by criteria(s) using an API Query Parameter called <code>select</code>.
 * <p>
 * The syntax is:
...
public class Select {
     ...
     *
     * the regexp is: <code>"^(([a-z][a-zA-Z_0-9]*)::([a-zA-Z_0-9]+)(-|\\+)?)?((\\|[a-z][a-zA-Z_0-9]*)?::([a-zA-Z_0-9]+)(-|\\+)?)*"</code>
