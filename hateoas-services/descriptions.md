...
This "Simple Banking API Sample" serves to exemplify a way of using [HATEOAS](https://github.com/Nykredit/HATEOAS/wiki) in the form of
[HAL](http://stateless.co/hal_specification.html) in an easy and intuitive way.

Furthermore it points to elaborated examples and what would be nice to have supported in a better way in the REST implementations and possibly
in Swagger in order have an easy way to use the full potential of HATEOAS in the form of HAL and services.

## API Description

This API shows a very simple set of resources that emulate three micro-services which are: Account, Payment and Person.
...
[Read more about the Capabilities](https://github.com/Nykredit/HATEOAS).

## General Principles

A semantic REST API is used and thus also [HATEOAS](https://github.com/Nykredit/HATEOAS/wiki) in form of
...
It is possible to express the same versioning without using the parameters as shown above using 
- although less elegant and less HTTPish and semantically poor:
...
The terms of using the service is as follows, the contract found at <https://sample-bank.dk/services/contracts/2345678> states the general terms
for using this service. Consumers can create their own individual contract and terms for usage at <https://sample-bank.dk/services/consumers>.
